...
const Employees = () => {
  ...
  const { confirmation, confirmDelete, handleConfirm, handleCancel } =
  ...
  const employees =
    employeesData?.data?.employees || employeesData?.employees || [];
  const pagination =
    employeesData?.data?.pagination || employeesData?.pagination || {};
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedEmployee) {
      handleUpdateEmployee({ id: getEmployeeId(selectedEmployee), data });
    } else {
  ...
  const handleDelete = (employee) => {
    ...
    if (!employeeId) {
      toast.error("Unable to delete employee: missing employee ID");
      return;
    }
  ...
  return (
    <PageShell
      ...
      contentClassName="space-y-6 p-4 md:p-8"
    >
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1 font-medium">
            Manage human resources and organizational structure
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          ...
          <h3 className="text-3xl font-black text-slate-900 tracking-tighter">
            {departmentsData?.data?.departments?.length || 0}
          </h3>
          <div className="mt-2 text-[10px] font-bold text-slate-400 uppercase tracking-tight">
            Operational units
          </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="mt-2 text-[10px] font-bold text-emerald-500 uppercase tracking-tight">
            Productive status
          </div>
        </div>
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
            ...
            <div className="p-8 overflow-y-auto flex-1">
              <form onSubmit={handleSubmit} className="space-y-8">
                {/* Basic Section */}
                <div>
                  <h3 className="text-[10px] font-black text-primary-600 uppercase tracking-widest mb-6 border-b border-primary-100 pb-2">
                    Primary Information
                  </h3>
