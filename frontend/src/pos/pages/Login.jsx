            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 lg:p-10 border border-gray-100">
              ...
              >
                <button
                  ...
                  className={`flex-1 rounded-lg py-2.5 text-sm font-semibold transition-colors ${activeTab === TAB_PASSWORD
                ...
                <button
                  ...
                  className={`flex-1 rounded-lg py-2.5 text-sm font-semibold transition-colors ${activeTab === TAB_2FA
                      ? 'bg-white text-gray-900 shadow-sm'
                      : 'text-gray-600 hover:text-gray-900'
                    }`}
                >
