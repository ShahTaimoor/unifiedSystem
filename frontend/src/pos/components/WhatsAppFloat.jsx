  ...
  return (
    <div className="pos-app">
      <a
        ...
        className="fixed bottom-20 right-4 sm:right-6 lg:bottom-6 z-[1000] flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] rounded-full shadow-lg hover:bg-[#20B858] transition-all duration-300 hover:scale-110 group"
